                ...
                <div className="grid gap-8 md:grid-cols-3">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400 max-w-xs">
                            Bachelor of Computer Science (Hons.) Multimedia Computing graduate passionate about interactive media, game development, data, AI, and creative digital experiences.
                        </p>
                    </div>
